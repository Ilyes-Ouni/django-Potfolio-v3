...
urlpatterns = [
path('diplomesFormationsCRUD/', views.index, name="diplomesFormationsCRUD"),

path('articles/del_art/<int:id>', views.del_art, name='del_art'),
path('articles/update_art/<int:id>', views.update_art, name='edit_art'),
...
path('categories/del_categorie/<int:id>', views.del_categorie),
...
path('users/update_user/<int:id>', views.update_user, name='edit_user'),
